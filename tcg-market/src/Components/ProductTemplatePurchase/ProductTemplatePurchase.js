...
const ProductTemplatePurchase = (props) => {
    const { sale, shipments, addresses, handleChangeObject } = props;
            ...
            <div className="card d-flex col-md-3" key={sale.id}>
                ...
                <div className="collapsable card-body ">
                    <div className="row blocks">
                        ...
                        <div className="col-12 col-lg">
                            <select class="form-select" aria-label="Elige tu forma de envio" name="envio" value={sale.envio.id} onChange={handleChangeObject}>
                        ...
                        <div className="col-12 col-lg">
                            <select class="form-select" aria-label="Elige tu dirección" name="dirección" value={sale.direccion.id} onChange={handleChangeObject}>
